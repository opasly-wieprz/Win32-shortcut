...
s_OK, s_FALSE, e_ABORT, e_ACCESSDENIED, e_FAIL, e_HANDLE         :: HRESULT
e_INVALIDARG, e_NOINTERFACE, e_NOTIMPL, e_OUTOFMEMORY, e_POINTER :: HRESULT
e_UNEXPECTED, rEGDB_E_CLASSNOTREG, cLASS_E_NOAGGREGATION         :: HRESULT
...
foreign import WINDOWS_CCONV "objbase.h CoInitialize"
  c_CoInitialize :: LPVOID -> IO HRESULT
